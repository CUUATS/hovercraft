...
Author URL: http://cuuats.org/

--------------------
=== Description ===
--------------------

Hovercraft is an accessible Wordpress theme for the Champaign Urbana Urbanized Area Transportation Study.
...
Hovercraft Wordpress Theme, Copyright (C) 2016 Champaign Urbana Urbanized Area Transportation Study.
Hovercraft is distributed under the terms of the GNU GPL license 2.0 or later.

Hovercraft is based on Aperture https://michaelvandenberg.com/, Copyright (C) 2015 Michael Van Den Berg.
Aperture is based on Underscores http://underscores.me/, Copyright (C) 2012-2015 Automattic, Inc.
...
-- Other.
*
*  Based on Aperture, Copyright (C) 2015 Michael Van Den Berg.
*  URL: https://michaelvandenberg.com/
*  License: GNU GPL License 2.0 [or later] / https://www.gnu.org/licenses/gpl-2.0.html
*
